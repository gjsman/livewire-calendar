...
<div
    ...
    <div
        ...
        <div
            ...
            @endif
            class="w-full h-full p-2 @if($day->format('l')=='Saturday' || $day->format('l')'Sunday') {{ 'bg-gray-100' }} @endif {{ $dayInMonth ? $isToday ? 'bg-yellow-100' : ' bg-white ' : 'bg-gray-100' }} flex flex-col">
